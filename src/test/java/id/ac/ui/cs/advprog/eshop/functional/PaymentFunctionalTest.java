...
class PaymentFunctionalTest {
   ...
   @Test
   void testPaymentDetailPageIsAccessible(ChromeDriver driver) throws Exception {
      driver.get(baseUrl + "/payment/detail");
      assertEquals("Payment Detail Form", driver.getTitle());
   }

   @Test
   void testPaymentAdminListPageIsAccessible(ChromeDriver driver) throws Exception {
