...
class PaymentRepositoryTest {
   ...
   void setUp() {
      ...
      Payment payment1 = new VoucherPayment("payment-1", voucherData, order);
      payments.add(payment1);

      Map<String, String> bankData = new HashMap<>();
      bankData.put("bankName", "Bank Mandiri");
      bankData.put("referenceCode", "REF123");
      Payment payment2 = new BankTransferPayment("payment-2", bankData, order);
   ...
   void testFindByIdIfFound() {
      ...
      assertEquals("BANK", findResult.getMethod());
   }
